...
Usage (on Pi with RPICT3V1 connected):
    python3 test_serial.py                    # Use /dev/serial0, 20 samples
    python3 test_serial.py --port /dev/ttyAMA0
    python3 test_serial.py --count 100        # Read 100 samples
    python3 test_serial.py --timeout 30       # Read for 30 seconds
